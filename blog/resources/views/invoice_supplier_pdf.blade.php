...
<div class="container-fluid">
  ...
  <div class="box-body">
    ...
    <div class="row">
        <p class="m-title">
          @if(App\Model\Supplier::find($invoice->supplierID) && $invoice->supplierID != 0)
             {{App\Model\Supplier::find($invoice->supplierID)->supplierName}}
          @endif
        </p>
      ...
      <div class="table">
          <div class="table-row head">
            ...
            <div class="table-col"><b>GL Code</b></div>
        ...
        @foreach($items as $index => $item)
          <div class="table-row">
            ...
            <div class="table-col">{{$item->GLCode}}</div>
            <div class="table-col wide">{{$item->description}}</div>
            <div class="table-col small">{{$item->units}}</div>
            <div class="table-col small">{{$item->cost}}</div>
            <div class="table-col small">{{$item->total}}</div>
          </div>
        @endforeach
          <div class="table-row total">
            ...
            <div class="table-col small"></div>
            <div class="table-col small"></div>
            <div class="table-col small">{{$invoice->amount}}</div>
          </div>
      </div>
    </div>
