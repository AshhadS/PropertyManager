        ...
        columns: [
            ...
            },
            {
                ...
                render: function ( data, type, full, meta ) {
                  ...
                  var action = '<center><span class="inner wide"><a class="btn bg-green btn-sm attachment-edit-btn" data-toggle="tooltip" title="View" href="/agreement/getfields/'+data+'"><i class="fa fa-eye" aria-hidden="true"></i></a>';
